...
[Click here to add Knights Of Discord to your server/guild](https://discordapp.com/oauth2/authorize?client_id=487744442531315712&scope=bot&permissions=1342590032)

## Current State

The project is work in progress. Current functionality:

* Creation of a new game environment uppon joining a new server
* Maintenance of existing game environments uppon startup
